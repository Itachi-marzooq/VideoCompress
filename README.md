...
* `AUTH_USERS` - Put your ID & other Sudo Users IDs. Separate with **Space**. Just for using [Admin Commands](https://github.com/Itachi-marzooq/VideoCompress/tree/HEVC#admin-commands).
